...
public class MyTimePickerDialog extends Dialog {
    ...
    public MyTimePickerDialog(Context context) {
        super(context, com.rey.material.R.style.Material_App_Dialog_TimePicker_Light);
    }

    public MyTimePickerDialog(Context context, int style) {
    ...
    public MyTimePickerDialog hour(int hour){
        mTimePickerLayout.setHour(hour);
        return this;
    }

    public MyTimePickerDialog minute(int minute){
        mTimePickerLayout.setMinute(minute);
        return this;
    }

    public MyTimePickerDialog onTimeChangedListener(OnTimeChangedListener listener){
    ...
    private class TimePickerLayout extends android.widget.FrameLayout implements View.OnClickListener, TimePicker.OnTimeChangedListener{
        ...
        public void applyStyle(int resId){
            ...
            TypedArray a = context.obtainStyledAttributes(resId, com.rey.material.R.styleable.TimePickerDialog);
            mHeaderHeight = a.getDimensionPixelSize(com.rey.material.R.styleable.TimePickerDialog_tp_headerHeight, ThemeUtil.dpToPx(context, 120));
            mTextTimeColor = a.getColor(com.rey.material.R.styleable.TimePickerDialog_tp_textTimeColor, 0xFF000000);
            mTextTimeSize = a.getDimensionPixelSize(com.rey.material.R.styleable.TimePickerDialog_tp_textTimeSize, context.getResources().getDimensionPixelOffset(com.rey.material.R.dimen.abc_text_size_headline_material));
            String am = a.getString(com.rey.material.R.styleable.TimePickerDialog_tp_am);
            String pm = a.getString(com.rey.material.R.styleable.TimePickerDialog_tp_pm);
            a.recycle();
    ...
    public static class Builder extends Dialog.Builder implements OnTimeChangedListener {
        ...
        public Builder(){
            super(com.rey.material.R.style.Material_App_Dialog_TimePicker_Light);
            Calendar cal = Calendar.getInstance();
        ...
        public Builder(int hourOfDay, int minute){
            this(com.rey.material.R.style.Material_App_Dialog_TimePicker_Light, hourOfDay, minute);
        }
        ...
        protected Dialog onBuild(Context context, int styleId) {
            MyTimePickerDialog dialog = new MyTimePickerDialog(context, styleId);
            dialog.hour(mHour)
                    .minute(mMinute)
