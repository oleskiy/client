...
public class Deliver extends ActionBarActivity implements ToolbarManager.OnToolbarGroupChangedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new ChooseLockerFragment().newInstance();
        weartest.com.client.MyFragmentTransaction.StartFragmentTransaction(fragment, this, "deliver",R.id.deliver_fragment);
    }
